...
public class ProductDetailActivity extends AppCompatActivity {
    ...
    private ArrayList<Review_ProductDetail> arrayList;
...
//                });
        ...
        // Button moreReviewsBtn = findViewById(R.id.moreReviewsButton);
        //더 많은 리뷰 보기 버튼 클릭시 리뷰페이지로 이동
        // moreReviewsBtn.setOnClickListener(new View.OnClickListener() {
        //    @Override
        //   public void onClick(View v) {
        //      Intent intent = new Intent(ProductDetailActivity.this, Review_write.class);         //터치 x
        //     startActivity(intent);
        //  }
        // });
